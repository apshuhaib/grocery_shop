...
import 'package:e_commerce_test/application/cart/cart_bloc.dart' as _i9;
...
import 'package:e_commerce_test/domain/cart/cart_service.dart' as _i7;
import 'package:e_commerce_test/domain/customer/customer_service.dart' as _i3;
import 'package:e_commerce_test/domain/orders/order_service.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.OrderService>(() => _i6.OrderServiceimpl());
    gh.lazySingleton<_i7.CartService>(() => _i8.CartServiceImpl());
    gh.factory<_i9.CartBloc>(() => _i9.CartBloc(gh<_i7.CartService>()));
    gh.lazySingleton<_i10.ProductService>(() => _i11.ProductServiceimpl());
    gh.factory<_i12.CustomerBloc>(
        () => _i12.CustomerBloc(gh<_i3.CustomerService>()));
    gh.factory<_i13.OrderBloc>(() => _i13.OrderBloc(gh<_i5.OrderService>()));
